...
> [!NOTE]
> **Fork Notice:** This repository is forked from the original open-source project [srbhr/Resume-Matcher](https://github.com/srbhr/Resume-Matcher) created by [Saurabh Rai](https://srbhr.com). All original credits and licenses belong to the upstream authors and contributors.
